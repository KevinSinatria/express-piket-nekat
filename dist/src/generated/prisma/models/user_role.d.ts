...
export type user_roleWhereInput = {
    ...
    id?: Prisma.IntFilter<"user_role"> | number;
...
export type user_roleScalarWhereWithAggregatesInput = {
    ...
    id?: Prisma.IntWithAggregatesFilter<"user_role"> | number;
...
export type user_roleCreateInput = {
    role: Prisma.rolesCreateNestedOneWithoutUser_rolesInput;
    user: Prisma.usersCreateNestedOneWithoutUser_rolesInput;
};
...
export type user_roleUpdateInput = {
    role?: Prisma.rolesUpdateOneRequiredWithoutUser_rolesNestedInput;
    user?: Prisma.usersUpdateOneRequiredWithoutUser_rolesNestedInput;
};
...
export type user_roleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "user_id" | "role_id", ExtArgs["result"]["user_role"]>;
...
export interface user_roleFieldRefs {
    readonly id: Prisma.FieldRef<"user_role", 'Int'>;
